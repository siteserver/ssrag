...
var cloud = _.extend(
  axios.create({
    ...
    baseURL: "https://api.ssrag.com",
    headers: {
      Authorization: "Bearer " + $cloudToken,
    },
  }),
  {
    host: "https://ssrag.com",
    hostImages: "https://images.ssrag.com",
    hostDl: "https://dl.ssrag.com",
    hostDemo: "https://demo.ssrag.com",
    hostStorage: "https://dl.ssrag.com",

    getDocsUrl: function (relatedUrl) {
      return this.host + "/docs/" + relatedUrl;
    },
    ...
    getPluginIconUrl: function (plugin) {
      ...
      return (
        ...
        plugin.pluginId +
        "/logo" +
        plugin.icon.substring(plugin.icon.lastIndexOf("."))
      );
    },
    ...
    getExtensions: function (sysVersion, word) {
      return this.post("sys/extensions", {
        sysVersion: sysVersion,
        word: word,
      });
    },

    getExtension: function (sysVersion, userName, name) {
      return this.post("sys/extensions/actions/getExtension", {
        sysVersion: sysVersion,
        userName: userName,
        name: name,
    ...
    getUpdates: function (sysVersion, pluginIds) {
      return this.post("sys/extensions/actions/getUpdates", {
        sysVersion: sysVersion,
        pluginIds: pluginIds,
      });
    },
