var $url = "/settings/configsAccessTokens";
...
var methods = {
  ...
  btnAdminViewClick: function (row) {
    utils.openLayer({
      title: "查看资料",
      url: utils.getCommonUrl("adminLayerView", { uuid: row.adminUuid }),
      full: true,
    });
  },
  ...
  btnViewClick: function (item) {
    utils.openLayer({
      title: "获取密钥",
      url: utils.getSettingsUrl("configsAccessTokensLayerView", { id: item.id }),
      width: 550,
      height: 410,
    });
  },
