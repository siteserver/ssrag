...
var methods = {
  ...
  btnViewClick: function (row) {
    ...
    utils.openLayer({
      title: "查看资料",
      url: utils.getCommonUrl("adminLayerView", { uuid: row.uuid }),
      full: true,
    });
  },
  ...
  btnPermissionSubmitClick: function () {
    ...
    $api
      .post($url + "/permissions/" + this.permissionInfo.adminId, {
