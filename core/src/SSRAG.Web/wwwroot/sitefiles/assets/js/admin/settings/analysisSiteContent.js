...
var data = utils.init({
  form: {
    ...
    dateFrom:
      ...
      utils.formatDate(new Date(now.setMonth(now.getMonth() - 1))),
...
var methods = {
  ...
  btnSearchClick() {
    var siteId =
      this.siteIds && this.siteIds.length > 0 ? this.siteIds[this.siteIds.length - 1] : 0;
    location.href =
      "?dateFrom=" + this.form.dateFrom + "&dateTo=" + this.form.dateTo + "&siteId=" + siteId;
  },
...
Vue.component("line-chart", {
  ...
  mounted: function () {
    this.renderChart(this.$root.chartData, {
      responsive: true,
