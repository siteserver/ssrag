...
var methods = {
  ...
  apiList: function (useless, page, message) {
    ...
    var channelId =
      this.channelIds && this.channelIds.length > 0
        ? this.channelIds[this.channelIds.length - 1]
        : this.channelId;
        ...
        $this.apiDelete(
          {
            ...
            restoreChannelId:
              $this.restoreForm.restoreChannelIds[$this.restoreForm.restoreChannelIds.length - 1],
          },
  ...
  getColumnWidth: function (column) {
    if (
      column.attributeName === "Sequence" ||
      column.attributeName === "Id" ||
      column.attributeName === "Hits" ||
      column.attributeName === "Downloads"
    ) {
      return 70;
    }
    ...
    if (column.attributeName === "Uuid" || column.attributeName === "SourceId") {
      return 310;
    }
