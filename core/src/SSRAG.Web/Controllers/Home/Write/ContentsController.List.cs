...
namespace SSRAG.Web.Controllers.Home.Write
{
    public partial class ContentsController
    {
        ...
        public async Task<ActionResult<ListResult>> List([FromBody] ListRequest request)
        {
            ...
            var (total, pageSummaries) = await _contentRepository.UserWriteSearchAsync(_authManager.UserName, site, request.Page, channelId, request.IsCheckedLevels, request.CheckedLevels, request.GroupNames, request.TagNames);
