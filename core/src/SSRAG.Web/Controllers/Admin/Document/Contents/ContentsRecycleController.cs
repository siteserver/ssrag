...
namespace SSRAG.Web.Controllers.Admin.Document.Contents
{
    ...
    {
        private const string Route = "document/contents/contentsRecycle";
        private const string RouteDelete = "document/contents/contentsRecycle/actions/delete";
        private const string RouteList = "document/contents/contentsRecycle/actions/list";
        private const string RouteTree = "document/contents/contentsRecycle/actions/tree";
        private const string RouteColumns = "document/contents/contentsRecycle/actions/columns";
