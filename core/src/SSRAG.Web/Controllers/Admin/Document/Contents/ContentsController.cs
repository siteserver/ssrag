...
namespace SSRAG.Web.Controllers.Admin.Document.Contents
{
    ...
    {
        private const string RouteList = "document/contents/contents/actions/list";
        private const string RouteTree = "document/contents/contents/actions/tree";
        private const string RouteCreate = "document/contents/contents/actions/create";
        private const string RouteColumns = "document/contents/contents/actions/columns";
        private const string RouteWidth = "document/contents/contents/actions/width";
        private const string RouteOrder = "document/contents/contents/actions/order";
        private const string RouteAll = "document/contents/contents/actions/all";
        private const string RouteSaveIds = "document/contents/contents/actions/saveIds";
