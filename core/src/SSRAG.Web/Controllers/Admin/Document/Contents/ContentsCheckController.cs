...
namespace SSRAG.Web.Controllers.Admin.Document.Contents
{
    ...
    {
        private const string RouteList = "document/contents/contentsCheck/actions/list";
        private const string RouteTree = "document/contents/contentsCheck/actions/tree";
        private const string RouteColumns = "document/contents/contentsCheck/actions/columns";
        private const string RouteSaveIds = "document/contents/contentsCheck/actions/saveIds";
