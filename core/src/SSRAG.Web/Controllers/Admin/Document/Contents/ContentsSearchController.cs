...
namespace SSRAG.Web.Controllers.Admin.Document.Contents
{
    ...
    {
        private const string RouteList = "document/contents/contentsSearch/actions/list";
        private const string RouteTree = "document/contents/contentsSearch/actions/tree";
        private const string RouteCreate = "document/contents/contentsSearch/actions/create";
        private const string RouteColumns = "document/contents/contentsSearch/actions/columns";
        private const string RouteWidth = "document/contents/contentsSearch/actions/width";
        private const string RouteSaveAllIds = "document/contents/contentsSearch/actions/saveAllIds";
        private const string RouteSaveIds = "document/contents/contentsSearch/actions/saveIds";
