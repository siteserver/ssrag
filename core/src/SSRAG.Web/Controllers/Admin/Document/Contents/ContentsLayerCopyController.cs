...
namespace SSRAG.Web.Controllers.Admin.Document.Contents
{
    ...
    {
        private const string Route = "document/contents/contentsLayerCopy";
        private const string RouteOptions = "document/contents/contentsLayerCopy/actions/options";
        ...
        public ContentsLayerCopyController(
