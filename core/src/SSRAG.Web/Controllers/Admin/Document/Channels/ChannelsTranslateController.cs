...
namespace SSRAG.Web.Controllers.Admin.Document.Channels
{
    ...
    {
        private const string Route = "document/channels/channelsTranslate";
        private const string RouteOptions = "document/channels/channelsTranslate/actions/options";
        ...
        private async Task TranslateAsync(Site site, int targetSiteId, int targetChannelId, ChannelTranslateType translateType, IEnumerable<int> channelIds, bool isDeleteAfterTranslate, string adminName)
        {
        ...
        private async Task TranslateChannelAndContentAsync(Site site, List<Channel> nodeInfoList, int targetSiteId, int parentId, ChannelTranslateType channelTranslateType, List<string> nodeIndexNameList, List<string> filePathList, bool isDeleteAfterTranslate)
        {
            ...
            {
                _pathManager.MoveFileByChannel(site, targetSite, oldNodeInfo);
        ...
        private async Task TranslateContentAsync(Site site, int channelId, int targetSiteId, int targetChannelId, bool isDeleteAfterTranslate)
        {
            ...
            {
                await ContentUtility.TranslateAsync(_pathManager, _databaseManager, _pluginManager, site, channelId, contentId, targetSiteId, targetChannelId, translateType, _createManager, _authManager.AdminName);
            }
        }
    }
}
