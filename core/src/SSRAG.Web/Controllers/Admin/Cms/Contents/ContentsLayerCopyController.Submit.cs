    ...
    public partial class ContentsLayerCopyController
    {
        ...
        public async Task<ActionResult<BoolResult>> Submit([FromBody] SubmitRequest request)
        {
            ...
            foreach (var transChannelId in request.TransChannelIds)
            {
                ...
                {
                    await ContentUtility.TranslateAsync(_pathManager, _databaseManager, _pluginManager, site, summary.ChannelId, summary.Id, request.TransSiteId, transChannelId, request.CopyType, _createManager, _authManager.AdminName);
                }
            }
