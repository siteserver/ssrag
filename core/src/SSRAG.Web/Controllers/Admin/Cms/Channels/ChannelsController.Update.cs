...
namespace SSRAG.Web.Controllers.Admin.Cms.Channels
{
    public partial class ChannelsController
    {
        ...
        public async Task<ActionResult<UpdateResult>> Update([FromBody] UpdateRequest request)
        {
            ...
            var datasetIndex = false;
            var datasetRemove = false;
            if (channel.Knowledge != request.Knowledge)
            {
                datasetIndex = request.Knowledge;
                datasetRemove = !request.Knowledge;
                channel.Knowledge = request.Knowledge;
            }
