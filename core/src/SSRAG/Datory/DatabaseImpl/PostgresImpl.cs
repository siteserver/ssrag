...
{
    internal class PostgresImpl : IDatabaseImpl
    {
        ...
        public static IDatabaseImpl Instance
        {
            get
            {
                ...
                _instance = new PostgresImpl();
                return _instance;
            }
        }

        public string GetConnectionString(string server, bool isDefaultPort, int port, string userName, string password, string databaseName, string schema)
        {
