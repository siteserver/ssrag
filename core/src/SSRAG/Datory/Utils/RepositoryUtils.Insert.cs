...
namespace SSRAG.Datory.Utils
{
    ...
    {
        public static async Task<int> InsertObjectAsync<T>(IDatabase database, string tableName, IEnumerable<TableColumn> tableColumns, IDistributedCache cache, T dataInfo, Query query = null) where T : Entity
        {
