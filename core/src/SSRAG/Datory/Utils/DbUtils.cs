...
namespace SSRAG.Datory.Utils
{
    public static class DbUtils
    {
        ...
        public const string TableNameSite = "ssrag_site";
        ...
        public static string GetConnectionString(DatabaseType databaseType, string server, bool isDefaultPort, int port, string userName, string password, string databaseName, string schema)
        {
            return GetInstance(databaseType).GetConnectionString(server, isDefaultPort, port, userName, password, databaseName, schema);
        }

        internal static Compiler GetCompiler(DatabaseType databaseType)
        {
            return GetInstance(databaseType).GetCompiler();
        }
