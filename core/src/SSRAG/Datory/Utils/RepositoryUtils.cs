...
namespace SSRAG.Datory.Utils
{
    internal static partial class RepositoryUtils
    {
        ...
        private static async Task<CompileInfo> CompileAsync(IDatabase database, string tableName, IDistributedCache cache, Query query)
        {
            ...
            var compiler = DbUtils.GetCompiler(database.DatabaseType);
