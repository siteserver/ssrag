...
namespace SSRAG.Utils
{
    public static class PathUtils
    {
        ...
        public static string GetUploadFileName(string filePath, bool isUploadChangeFileName)
        {
            ...
            {
                return $"{StringUtils.GetShortUuid(false)}{GetExtension(filePath)}";
            }
        ...
        {
            if (string.IsNullOrEmpty(filename)) return StringUtils.ToLower(StringUtils.GetShortUuid());
        ...
        {
            return Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".ssrag",
