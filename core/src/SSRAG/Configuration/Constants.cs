...
namespace SSRAG.Configuration
{
    ...
    {
        public const string AdminTitle = "SSRAG";
        public const string ConfigFileName = "ssrag.json";
        ...
        public const int DefaultMemoryExpireMinutes = 5;
        public const int DefaultRedisExpireMinutes = 60;
        ...
        public const string OfficialHost = "https://ssrag.com";
        public const string SessionIdPrefix = "SESSION-ID-";

        public static DateTime SqlMinValue { get; } = new DateTime(1754, 1, 1, 0, 0, 0, 0);

        public static string GetSessionIdCacheKey(string userName)
        {
            return $"{SessionIdPrefix}{userName}";
        }
