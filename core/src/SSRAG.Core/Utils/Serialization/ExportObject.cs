...
using SSRAG.Utils;
using SSRAG.Dto;
using FileUtils = SSRAG.Utils.FileUtils;
...
namespace SSRAG.Core.Utils.Serialization
{
    public class ExportObject
    {
        ...
        public ExportObject(IPathManager pathManager, IDatabaseManager databaseManager, Caching caching, Site site)
        {
        ...
        public void ExportMetadata(string siteTemplateName, string webSiteUrl, string description, string samplePicPath, string metadataPath)
        {
            ...
            var xmlPath = PathUtils.Combine(metadataPath, DirectoryUtils.SiteFiles.Templates.FileMetadata);
