...
namespace SSRAG.Core.Repositories
{
    public class PluginConfigRepository : IPluginConfigRepository
    {
        ...
        {
            _repository = new Repository<PluginConfig>(settingsManager.Database, settingsManager.Cache);
        ...
        {
            return _settingsManager.Cache.GetEntityKey(_repository.TableName, pluginId, $"{siteId}_{name}");
        }
