...
using SSRAG.Utils;
using TableColumn = SSRAG.Datory.TableColumn;
...
namespace SSRAG.Core.Repositories
{
    public partial class TableStyleRepository : ITableStyleRepository
    {
        ...
        {
            _repository = new Repository<TableStyle>(settingsManager.Database, settingsManager.Cache);
        ...
        {
            return _settingsManager.Cache.GetListKey(_repository.TableName, tableName);
        }
