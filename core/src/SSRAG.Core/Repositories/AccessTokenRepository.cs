...
namespace SSRAG.Core.Repositories
{
    public partial class AccessTokenRepository : IAccessTokenRepository
    {
        ...
        public AccessTokenRepository(ISettingsManager settingsManager)
        {
            ...
            _repository = new Repository<AccessToken>(settingsManager.Database, settingsManager.Cache);
        }
        ...
        {
            var token = _settingsManager.Encrypt(StringUtils.Uuid());
        ...
        public async Task<string> RegenerateAsync(AccessToken accessToken)
        {
            ...
            accessToken.Token = _settingsManager.Encrypt(StringUtils.Uuid());
