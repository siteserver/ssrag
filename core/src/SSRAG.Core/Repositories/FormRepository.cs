...
namespace SSRAG.Core.Repositories
{
    public partial class FormRepository : IFormRepository
    {
        ...
        public FormRepository(ISettingsManager settingsManager, ITableStyleRepository tableStyleRepository)
        {
            ...
            _repository = new Repository<Form>(settingsManager.Database, settingsManager.Cache);
        }
        ...
        {
            return _settingsManager.Cache.GetListKey(TableName, siteId);
        }
        ...
        public List<ContentColumn> GetColumns(List<string> listAttributeNames, List<TableStyle> styles, bool isReply)
        {
            var columns = new List<ContentColumn>
            {
                ...
                new ContentColumn
                {
                    AttributeName = nameof(FormData.Uuid),
                    DisplayName = "编号",
                    IsList = ListUtils.ContainsIgnoreCase(listAttributeNames, nameof(FormData.Uuid))
                }
            };
