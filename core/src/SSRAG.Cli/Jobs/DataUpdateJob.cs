...
namespace SSRAG.Cli.Jobs
{
    public class DataUpdateJob : IJobService
    {
        ...
        public async Task WriteUsageAsync(IConsoleUtils console)
        {
            ...
            await console.WriteLineAsync($"Docs: {Configuration.Constants.OfficialHost}/docs/cli/commands/data-update.html");
        ...
        public async Task ExecuteAsync(IPluginJobContext context)
        {
            ...
            await console.WriteLineAsync($"Backup folder: {oldTree.DirectoryPath}, Update folder: {newTree.DirectoryPath}, Update to SSRAG version: {_settingsManager.Version}");
