...
namespace SSRAG.Cli.Jobs
{
    public class RegisterJob : IJobService
    {
        ...
        public async Task WriteUsageAsync(IConsoleUtils console)
        {
            ...
            await console.WriteLineAsync($"Docs: {Constants.OfficialHost}/docs/cli/commands/register.html");
        ...
        public async Task ExecuteAsync(IPluginJobContext context)
        {
            ...
            if (success)
            {
                await console.WriteSuccessAsync("you have registered successfully, run ssrag login to log in.");
            }
            else
            {
