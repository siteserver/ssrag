...
namespace SSRAG.Cli.Jobs
{
    public class UpdateJob : IJobService
    {
        ...
        public async Task WriteUsageAsync(IConsoleUtils console)
        {
            ...
            await console.WriteLineAsync("Summary: update ssrag");
            await console.WriteLineAsync($"Docs: {Constants.OfficialHost}/docs/cli/commands/update.html");
        ...
        public async Task ExecuteAsync(IPluginJobContext context)
        {
            ...
            {
                await console.WriteErrorAsync($"SSRAG has not been installed in {contentRootPath}");
                return;
            }
            ...
            {
                await console.WriteLineAsync($"SSRAG {result.Cms.Version} is the latest version and no update is required");
            ...
            //await console.WriteSuccessAsync($"Congratulations, SSRAG was updated to {result.Cms.Version} successfully!");
        }
